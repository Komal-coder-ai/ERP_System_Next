...
export default function EditSalePage() {
  ...
  const addItem = () => {
    setItems([...items, { productId: '', productName: '', quantity: '', unitPrice: '', totalPrice: 0 }]);
  };
      ...
      <div className="min-h-screen bg-neutral-100 p-4 sm:p-6 lg:p-8">
        <div className="flex justify-center items-center h-96">
          <div className="text-center">
            ...
            <p className="text-neutral-600 mt-4">Loading sale...</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-neutral-100 p-4 sm:p-6 lg:p-8">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-bold text-neutral-900 mb-2">Edit Sale</h1>
        <p className="text-neutral-600">Update the sale details and status</p>
      </div>
      ...
      <div className="bg-white rounded-lg border border-neutral-200 shadow-sm overflow-hidden">
        <form onSubmit={handleSubmit} className="p-8">
          ...
          <div className="mb-8">
            <h2 className="text-lg font-bold text-neutral-900 mb-6">Customer Information</h2>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-bold text-neutral-900">Sale Items</h2>
              <button
                type="button"
                onClick={addItem}
