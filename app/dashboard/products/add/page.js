...
export default function AddProductPage() {
  ...
  const handleImageFiles = async (files) => {
    // Convert FileList to array of base64 URLs
    ...
    setFormData(prev => {
      ...
      if (!all.some(img => img.isPrimary) && all.length > 0) {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="card shadow-lg">
          <div className="card-header bg-primary-50 border-b border-primary-100">
            <h2 className="text-2xl font-bold text-neutral-900">➕ Create New Product</h2>
          </div>
